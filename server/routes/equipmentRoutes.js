...
const { getEquipment, getEquipmentById, createEquipment, updateEquipment, deleteEquipment, getEquipmentAIReport } = require('../controllers/equipmentController');
...
router.get('/:id/ai-report', validateIdParam, protect, requireRole('admin'), getEquipmentAIReport);
